...
# CASE 3: SINGLE-SCALE ENCODER
# - Khôi phục Attention ở Bottleneck và ECA ở Decoder về nguyên bản.
# - Loại bỏ cơ chế Dual/Multi-scale ở Encoder, chỉ sử dụng Single-scale (3x3).
# ==============================================================================
...
# ==============================================================================
# 3. KHỐI ENCODER (CHỈ CÒN DUY NHẤT SINGLE-SCALE CHO CASE 3)
# ==============================================================================
class SingleScale_PFCU_DG(nn.Module):
    def __init__(self, dim, act_type='relu6'):
        super().__init__()
        # Chỉ giữ lại 1 lớp SquareDW 3x3
    ...
    def forward(self, x):
        ...
        # Pointwise fusion chỉ trên nhánh b3
...
class EncoderBlock(nn.Module):
    def __init__(self, in_c, out_c, is_deep=False, act_type='relu6'):
        super().__init__()
        # Không phân biệt is_deep nữa, tất cả đều dùng Single-scale 3x3
...
# ==============================================================================
# 4. DECODER (ADDITIVE) & BOTTLE-NECK (ĐÃ KHÔI PHỤC)
# ==============================================================================
class AdditiveDecoderBlock(nn.Module):
    def __init__(self, in_c, skip_c, out_c, act_type='hswish'):
        ...
        self.refine = nn.Sequential(
            ...
            ECABlock(gc, act_type),  # ECABlock khôi phục cho Case 3
...
class SerialMultiScaleBottleneck(nn.Module):
    def __init__(self, dim, act_type='hswish'):
        ...
        # Channel & Spatial Attention khôi phục cho Case 3
