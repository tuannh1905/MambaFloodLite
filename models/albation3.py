...
# - CHỈNH SỬA: Cắt bỏ hoàn toàn nhánh dg_shortcut trong khối PFCU-DG.
# - GIỮ LẠI: Nhánh Đa tỷ lệ (3x3, 5x5, 7x7), TinyUAFM_v2, SPP Bottleneck.
# ==============================================================================
...
class DecoderBlock(nn.Module):
    def __init__(self, in_c, out_c):
        ...
        # ✓ ĐÃ ĐỔI SANG BẢN ABLATION: MultiScale_PFCU_NoDG
        self.pfcu_dg = MultiScale_PFCU_NoDG(gc)
