...
# ==============================================================================
# 2. ENCODER TỐI GIẢN (KHÔNG ATTENTION)
# ==============================================================================
...
# ==============================================================================
# 4. MẠNG ABLATION 4: BASELINE (KHÔNG CÓ AUXILIARY HEAD)
# ==============================================================================
class Ablation4_NoAux(nn.Module):
    def __init__(self, num_classes=1, input_size=128):
        ...
        # [LOẠI BỎ HOÀN TOÀN self.aux_head Ở ĐÂY]
    ...
    def forward(self, x):
        # Không cần thiết phải lấy input_shape nữa vì không có nội suy
        ...
        # [LOẠI BỎ HOÀN TOÀN LUỒNG TÍNH TOÁN AUX Ở ĐÂY]
        ...
        # Chỉ trả về 1 tensor duy nhất, dù là Train hay Eval
        return main_out

# Hàm build chuẩn cho file get_model của bạn
def build_model(num_classes=1, input_size=128):
    return Ablation4_NoAux(num_classes=num_classes, input_size=input_size)