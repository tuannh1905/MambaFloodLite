...
class DecoderStageK3ReLU6(nn.Module):
    # Ablation 21: refine dùng depthwise kernel_size=3 thay vì kernel_size=5.
    def __init__(self, in_channels: int, skip_channels: int, out_channels: int):
        ...
        self.refine = nn.Sequential(
            ...
            DepthwiseConvBN(hidden_channels, kernel_size=3),
...
class FSENetDecoder3x3(nn.Module):
    # Ablation 21: FSENet với decoder refine dùng depthwise kernel_size=3 thay vì kernel_size=5.
    ...
    def __init__(self, num_classes: int = 1, aux_hidden_channels: int = 64):
        ...
        self.d4 = DecoderStageK3ReLU6(in_channels=c4, skip_channels=c4, out_channels=d4)
        self.d3 = DecoderStageK3ReLU6(in_channels=d4, skip_channels=c3, out_channels=d3)
        self.d2 = DecoderStageK3ReLU6(in_channels=d3, skip_channels=c2, out_channels=d2)
        self.d1 = DecoderStageK3ReLU6(in_channels=d2, skip_channels=c1, out_channels=d1)
...
def build_model(num_classes: int = 1, **kwargs) -> FSENetDecoder3x3:
    return FSENetDecoder3x3(num_classes=num_classes, **kwargs)
