...
class DecoderBlock(nn.Module):
    ...
    def forward(self, x, skip):
        ...
        x = self.bn(self.pw(x))
        x = self.act(self.bn2(self.pw2(self.pw_up(self.dw(self.bn_mid(self.pw_down(x)))))) + x)
        return x
...
class ULiteModel(nn.Module):
    def __init__(self, num_classes=1):
        ...
        self.conv_in = nn.Conv2d(3, 16, kernel_size=3, padding=1, bias=False)
