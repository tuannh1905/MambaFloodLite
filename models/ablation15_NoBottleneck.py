...
class FSENetNoBottleneck(nn.Module):
    # Ablation 19: FSENet không có SerialBottleneck, đưa thẳng feature map cuối encoder vào decoder.
...
def build_model(num_classes: int = 1, **kwargs) -> FSENetNoBottleneck:
    return FSENetNoBottleneck(num_classes=num_classes, **kwargs)
