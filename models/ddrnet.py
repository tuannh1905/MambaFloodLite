...
class DualResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1, planes=64, spp_planes=128, head_planes=128):
...
class DDRNetModel(nn.Module):
    def __init__(self, num_classes=1):
        ...
        self.model = DualResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, planes=32, spp_planes=128, head_planes=64)

    def forward(self, x):
        return self.model(x)

def build_model(num_classes=1):
    return DDRNetModel(num_classes=num_classes)