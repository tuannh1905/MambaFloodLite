...
# ==============================================================================
# PICO-UNET V2: BẢN PAPER - TỐI ƯU HÓA CHO ESP32-S3 (BẢN "CƠ BẮP")
# - ✓ TỐI ƯU 1: AdditiveDecoderBlock (Cộng trực tiếp, 0% Peak RAM thừa).
# - ✓ TỐI ƯU 2: SerialMultiScaleBottleneck (Góc nhìn 3x3->5x5->7x7 cực rộng).
# - ✓ TỐI ƯU 3: Dual Attention (Channel ECA + Spatial Định vị vùng nước).
# - ✓ TỐI ƯU 4: Nâng cấp toàn bộ thành Hardswish.
# - ✓ TỐI ƯU 5 (NEW): Nhân đôi Base Channel (32->256) ép mIoU lên cực đại (~211k params).
# ==============================================================================
...
# ==============================================================================
# 4. DECODER (ADDITIVE) & BOTTLE-NECK (SERIAL MULTI-SCALE)
# ==============================================================================
...
# ==============================================================================
# 5. MẠNG CHÍNH PICO-UNET V2 PAPER (BẢN WIDE-PICO)
# ==============================================================================
class PicoUNet_v2_Paper(nn.Module):
    def __init__(self, num_classes=1, input_size=128):
        ...
        # ✓ NÂNG CẤP TẦNG NÔNG: Bắt đầu từ 32 kênh để tóm nét cực gắt
        self.conv_in = nn.Conv2d(3, 32, kernel_size=3, padding=1)
        
        # ✓ MỞ RỘNG CƠ BẮP: 32 -> 64 -> 128 -> 256 -> 256 (Chốt hạ)
        self.e1 = EncoderBlock_v2(32, 64)
        self.e2 = EncoderBlock_v2(64, 128)
        self.e3 = EncoderBlock_v2(128, 256)
        self.e4 = EncoderBlock_v2(256, 256) 
        
        # Bottleneck Đa tỷ lệ chạy trên mặt phẳng 256 kênh
        self.bottleneck = SerialMultiScaleBottleneck(256)
        
        # Decoder lùi đối xứng
        self.d4 = AdditiveDecoderBlock(256, 256)
        self.d3 = AdditiveDecoderBlock(256, 128)
        self.d2 = AdditiveDecoderBlock(128, 64)
        self.d1 = AdditiveDecoderBlock(64, 32)
