...
class ConcatDecoderBlock_3x3(nn.Module):
...
class Ablation21_Decoder3x3(nn.Module):
    def __init__(self, num_classes=1, input_size=128):
        ...
        self.d4 = ConcatDecoderBlock_3x3(128, 128, 128)
        self.d3 = ConcatDecoderBlock_3x3(128, 128, 64)
        self.d2 = ConcatDecoderBlock_3x3(64, 128, 32)
        self.d1 = ConcatDecoderBlock_3x3(32, 64, 16)
...
def build_model(num_classes=1, input_size=128):
    return Ablation21_Decoder3x3(num_classes=num_classes, input_size=input_size)
