...
# ==============================================================================
# 3. AXIAL-PFCU-DG BLOCK (Khối Encoder Lõi)
# ==============================================================================
...
# ==============================================================================
# 4. ENCODER, DECODER & BẢN C BOTTLENECK (No SPP)
# ==============================================================================
...
class BottleNeckBlock(nn.Module):
    """
    BẢN C (ABLATION STUDY): 
    Loại bỏ hoàn toàn SPP và các nhánh Dilation song song.
    Thay bằng 1 lớp AxialDW thông thường (dilation=1) để đánh giá độ suy giảm mIoU.
    """
    def __init__(self, dim, max_dim=128):
        super().__init__()
        # Trái tim của Bottleneck giờ chỉ là 1 lớp AxialDW duy nhất
        self.axial_dw = AxialDW(dim, mixer_kernel=(5, 5), dilation=1)
        self.bn = nn.BatchNorm2d(dim)
        self.act = nn.PReLU(dim)
...
# ==============================================================================
# 5. MẠNG CHÍNH (ULITE-ABLATION-C)
# ==============================================================================
class ULiteModel_Ablation_C(nn.Module):
...
def build_model(num_classes=1):
    return ULiteModel_Ablation_C(num_classes=num_classes)