...
# ==============================================================================
# 0. CUSTOM ACTIVATIONS: CHUẨN RELU CỔ ĐIỂN
# ==============================================================================
def get_activation(act_type):
    # Trả về ReLU tiêu chuẩn (không giới hạn biên độ trên)
    if act_type == 'relu':
...
# ==============================================================================
# 2. ENCODER TỐI GIẢN (ALL RELU)
# ==============================================================================
class Straight3x3Block(nn.Module):
    def __init__(self, dim, act_type='relu'): 
        super().__init__()
...
# ==============================================================================
# 3. DECODER & BOTTLE-NECK (ALL RELU)
# ==============================================================================
class ConcatDecoderBlock_NoAttn(nn.Module):
    def __init__(self, in_c, skip_c, out_c, act_type='relu'):
        super().__init__()
...
# ==============================================================================
# 4. MẠNG ABLATION 9: ALL RELU TIÊU CHUẨN
# ==============================================================================
class Ablation9_ReLU(nn.Module):
    def __init__(self, num_classes=1, input_size=128):
        ...
        # Truyền act_type='relu' cho toàn bộ mạng
        self.e1 = EncoderBlock(16, 32,   act_type='relu')   
        self.e2 = EncoderBlock(32, 64,   act_type='relu')   
        self.e3 = EncoderBlock(64, 128,  act_type='relu') 
        self.e4 = EncoderBlock(128, 128, act_type='relu') 
        ...
        self.aux_head = nn.Sequential(
            ...
            nn.ReLU(inplace=True), # Đổi luôn ở Aux Head thành ReLU
            nn.Conv2d(aux_dim, num_classes, kernel_size=1)
        )
        
        self.bottleneck = SerialBottleneck_NoAttn(128, act_type='relu')
        
        self.d4 = ConcatDecoderBlock_NoAttn(in_c=128, skip_c=128, out_c=128, act_type='relu') 
        self.d3 = ConcatDecoderBlock_NoAttn(in_c=128, skip_c=128, out_c=64,  act_type='relu')  
        self.d2 = ConcatDecoderBlock_NoAttn(in_c=64,  skip_c=64,  out_c=32,  act_type='relu')   
        self.d1 = ConcatDecoderBlock_NoAttn(in_c=32,  skip_c=32,  out_c=16,  act_type='relu')   
...
def build_model(num_classes=1, input_size=128):
    return Ablation9_ReLU(num_classes=num_classes, input_size=input_size)