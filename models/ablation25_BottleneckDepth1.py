...
class ShallowBottleneck(nn.Module):
    def __init__(self, dim, act_type='relu6'):
        super().__init__()
        self.dw1 = SquareDW(dim)
    def forward(self, x):
...
class Ablation25_BottleneckDepth1(nn.Module):
    def __init__(self, num_classes=1, input_size=128):
        ...
        self.bottleneck = ShallowBottleneck(128)
...
def build_model(num_classes=1, input_size=128):
    return Ablation25_BottleneckDepth1(num_classes=num_classes, input_size=input_size)
