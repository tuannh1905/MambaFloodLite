...
# ==============================================================================
# 5. MẠNG CHÍNH (FIBONACCI - BỘ 4)
# ==============================================================================
class ULiteModel_Fibonacci(nn.Module):
    def __init__(self, num_classes=1):
        ...
        # BỘ 4: CHUỖI FIBONACCI (Mở rộng hữu cơ, chống Gridding triệt để)
        self.e1 = EncoderBlock(16,  32,  mixer_kernel=mk, dilations=[1, 2, 3])
        self.e2 = EncoderBlock(32,  64,  mixer_kernel=mk, dilations=[1, 3, 5])
        self.e3 = EncoderBlock(64,  128, mixer_kernel=mk, dilations=[1, 5, 8])
        self.e4 = EncoderBlock(128, 256, mixer_kernel=mk, dilations=[1, 8, 13])

        self.b4 = BottleNeckBlock(256, max_dim=128)

        # DECODER: Thu hồi trường thụ cảm dần dần
        self.d4 = DecoderBlock(256, 128, mixer_kernel=mk, dilations=[1, 5, 8])
...
def build_model(num_classes=1):
    return ULiteModel_Fibonacci(num_classes=num_classes)